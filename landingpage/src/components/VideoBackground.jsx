      ...
      {!isModalOpen && (
        <div className="overlay-text">
          ...
          <p>
            ...
            network exceeding 100,000, MIT is a premier engineering institute
            approved by AICTE and affiliated with top Indian universities. Known
            for its commitment to innovation and quality education, MIT empowers
            students to meet global challenges through cutting-edge learning
            experiences.
          </p>
          <p>
          ...
          <p>
            ...
            transformative journey toward professional and personal excellence.
          </p>
        </div>
      )}
    </div>
